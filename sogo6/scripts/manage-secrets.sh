...
KEYS=(
  ...
  "SOGO_P_DB_PASS|Database application password|24"
  "POSTGRES_PASSWORD|PostgreSQL root password|24"
  "MARIADB_ROOT_PASSWORD|MariaDB root password|24"
  "MARIADB_PASSWORD|MariaDB application password|24"
  ...
  "SOGO_P_ADMIN_PWD|SOGo admin password (admin UI)|16"
)
