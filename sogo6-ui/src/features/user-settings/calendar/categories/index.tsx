...
import { CalendarsCategoriesSettingsForm } from './components/calendar-categories-form'
  ...
  return (
    <div className="grid grid-cols-1 gap-4">
      ...
      {isFetching ? (
        ...
        <CalendarsCategoriesSettingsForm
          data={data?.data}
...
export default CalendarsCategoriesSettings
