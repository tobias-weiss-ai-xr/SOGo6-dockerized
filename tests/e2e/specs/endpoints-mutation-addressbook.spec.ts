...
test.describe('Endpoint mutation matrix — Address Book (12 write endpoints / 12 tests)', () => {
  test('MUT-addressbook-1: authenticated POST /addressbooks does not 5xx', async ({ request }) => {
  ...
  test('MUT-addressbook-2: authenticated PATCH /addressbooks/0 does not 5xx', async ({ request }) => {
  ...
  test('MUT-addressbook-3: authenticated POST /addressbooks/0/contacts does not 5xx', async ({ request }) => {
  ...
  test('MUT-addressbook-4: authenticated PATCH /addressbooks/0/contacts/0 does not 5xx', async ({ request }) => {
  ...
  test('MUT-addressbook-5: authenticated POST /addressbooks/0/contacts/import does not 5xx', async ({ request }) => {
  ...
  test('MUT-addressbook-6: authenticated POST /addressbooks/0/lists does not 5xx', async ({ request }) => {
  ...
  test('MUT-addressbook-7: authenticated PATCH /addressbooks/0/lists/0 does not 5xx', async ({ request }) => {
  ...
  test('MUT-addressbook-8: authenticated POST /addressbooks/0/lists/import does not 5xx', async ({ request }) => {
  ...
  test('MUT-addressbook-9: authenticated POST /addressbooks/0/shares does not 5xx', async ({ request }) => {
  ...
  test('MUT-addressbook-10: authenticated POST /addressbooks/0/sync does not 5xx', async ({ request }) => {
  ...
  test('MUT-addressbook-11: authenticated POST /addressbooks/external does not 5xx', async ({ request }) => {
  ...
  test('MUT-addressbook-12: authenticated POST /addressbooks/import does not 5xx', async ({ request }) => {
